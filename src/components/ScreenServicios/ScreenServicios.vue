<template>
    <div>
      ...
      <nav class="sidebar-menu">
        ...
        <router-link to="/servicios" class="menu-item active">
         ° Otros servicios
        </router-link>
        ...
        <header class="top-bar">
            <div class="search-container">
                <input 
                  type="text"
                  v-model="searchQuery"
                  placeholder="Busca  tu servicio ideal..."
                  class="search-input"
                >
            </div>
        </header>
        <main class="feed-section">
            <h2 class="feed-title">Aqui podras encontrar otros servicios...🐕‍🦺</h2>
        </main>
    </div>
    </div>
</template>
...
<style scoped src="./ScreenServicios.css">
</style>