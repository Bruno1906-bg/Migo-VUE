    ...
    <div class="login-container">
      ...
      <form @submit.prevent="handleLoginVet" class="login-form" novalidate>
        <div class="input-group">
          ...
          <input v-model="email" type="email" id="email" name="username" placeholder="correo@veterinaria.com" autocomplete="username" required>
        </div>

        <div class="input-group">
          <label for="password">Contraseña</label>
          <div class="password-field">
            <input v-model="password" :type="showPassword ? 'text' : 'password'" id="password" placeholder="Tu contraseña (mínimo 8 caracteres)" minlength="8" required autocomplete="current-password">
